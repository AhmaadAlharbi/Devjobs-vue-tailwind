<template>
  <from
    class="max-w-5xl md:flex items-center -translate-y-5 w-full bg-white hidden"
  >
    ...
    <div class="bg-white flex justify-center items-center w-[100%]">
      <input type="checkbox" class="bg-Gray" />
      <label for="" class="text-black ml-3 font-bold">Full time only</label>
    </div>
    <button class="text-white bg-violet px-6 py-2 rounded-lg m-3">
      Search
    </button>
  </from>
  <!-- search on mobile -->
  ...
  >
    <div class="flex justify-between items-center mt-10">
      ...
      <div class="mx-2">
        <button class="bg-violet px-4 py-2">
          <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M17.112 15.059h-1.088l-.377-.377a8.814 8.814 0 002.15-5.784A8.898 8.898 0 008.898 0 8.898 8.898 0 000 8.898a8.898 8.898 0 008.898 8.899c2.211 0 4.23-.808 5.784-2.143l.377.377v1.081l6.845 6.832 2.04-2.04-6.832-6.845zm-8.214 0A6.16 6.16 0 118.9 2.737a6.16 6.16 0 010 12.322z"
              fill="#ffffff"
  ...
  <div v-if="showSearch" class="flex flex-col justify-center items-center">
    <div class="w-full h-full py-12 bg-white divide-y-2 divide-slate-200">
      ...
      <div
        class="bg-white flex flex-col justify-center items-center py-7 w-[100%]"
      >
        <div>
          <input type="checkbox" class="bg-Gray" />
          <label for="" class="text-black ml-3 font-bold">Full time only</label>
        </div>
        <button class="text-white bg-violet px-32 py-4 rounded-lg m-3">
          Search
        </button>
      </div>
    </div>
